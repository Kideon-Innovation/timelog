...
/* ---------- boot ---------- */
function boot(){
  // Hand the calendar renderer the two event/modal behaviours it needs from
  // this module: opening the edit dialog and attaching drag-to-select.
